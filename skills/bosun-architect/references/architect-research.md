...
**Conclusion**: No dedicated architecture-related skills, prompts, or tools exist in Superpowers. This represents an opportunity for bosun-architect to fill a gap.
...
**Key Insight**: These subagents span system design, infrastructure planning, code structure review, and specialized domain architecture. The bosun-architect skill could incorporate concepts from all of these, particularly the architect-reviewer and microservices-architect patterns.
