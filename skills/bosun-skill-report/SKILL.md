...
1. **Domain-Specific**
   - bosun-security, bosun-architect, bosun-testing
   - bosun-performance, bosun-devops, bosun-docs-writer
   - bosun-project-auditor, bosun-threat-model, bosun-ux-ui

2. **Language-Specific**
   - bosun-golang, bosun-typescript, bosun-python
   - bosun-javascript, bosun-rust, bosun-java, bosun-csharp

3. **Cloud/Platform**
   - bosun-aws, bosun-gcp, bosun-azure
...
|-------|-------|------|--------|
| bosun-security | 178 | 4 | security-agent |
| bosun-architect | 199 | 5 | quality-agent, architecture-agent |
| ... | ... | ... | ... |

### Language-Specific (7 skills)
| Skill | Lines | Refs | Agents |
|-------|-------|------|--------|
| bosun-golang | 271 | 4 | quality-agent, testing-agent |
| ... | ... | ... | ... |
```
...
```markdown
### Missing References
- bosun-security: security-headers.md
- bosun-architect: api-design.md, architecture-patterns.md
- bosun-golang: effective-go.md
...
- bosun-seo-llm: 329 lines (limit: 500)
```
...
3. **Expand thin skills** - bosun-azure has only 1 reference
```
...
- `bosun-skill-validator` for validation rules
